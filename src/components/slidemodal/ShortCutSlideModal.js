...
const ShortCutSlideModal = () => {
  ...
  //   useOnClickOutside(ref, toggleModalSlide);
  return (
    <div>
      <div
        class={` modal fade modal-shortcut modal-slide ${
          modalSlide && "show__modal show"
        }`}
        tabIndex="-1"
        role="dialog"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <button onClick={toggleModalSlide} type="button" class="close">
...
export default ShortCutSlideModal;
